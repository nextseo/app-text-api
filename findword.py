...
try:
  mycursor.execute("DELETE FROM proofstopword")
...
for xstop in range(0,len(stopwordgroup)):
        ...
        if startword>=1:
            print(startword)
            print(stopwordgroup[xstop])
            lenstr = len(stopwordgroup[xstop])
            endword = startword+lenstr-1
            print(endword)
            #####################
            mydb = mysql.connector.connect(
                host="nextsoftwarethailand.com",
            ...
            mycursor = mydb.cursor()
            sql = "INSERT INTO proofstopword (startword,endword,stopwordgroup) VALUES (%s,%s,%s)"
            val = (startword,endword,stopwordgroup[xstop])
            mycursor.execute(sql, val)
            mydb.commit() 
            print(mycursor.rowcount, "record inserted proofstopword.")  
